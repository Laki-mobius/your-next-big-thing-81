          ...
          {activeItem === 'metrics' && (
            <>
              ...
              <div className="grid grid-cols-4 gap-2.5 mb-3">
                <KpiCard
                  label="Total records"
                  value={pocMetrics.totalRecords.toLocaleString()}
                  delta={`${pocMetrics.matched}`}
                  subtitle="Matched companies in POC dataset"
                ...
                <KpiCard
                  ...
                  value={`${pocCoverageOverall}%`}
                  delta="4 attrs"
                  subtitle="Avg fill rate across 4 attributes"
                ...
                <KpiCard
                  ...
                  value={`${pocAccuracyOverall}%`}
                  delta={`${pocMetrics.matched + pocMetrics.possibleMatch}`}
                  subtitle="Match success rate"
                ...
                <KpiCard
                  ...
                  value={`${pocCurrentnessOverall}%`}
                  delta="14 days"
                  subtitle="Captured within last 2 weeks"
