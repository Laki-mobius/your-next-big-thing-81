...
const qcAttributes = [
  ...
  { name: 'Address', accuracy: 98, correct: 910, total: 929, status: 'passed' as const, issues: '19 Standardization Warnings' },
  { name: 'City', accuracy: 99, correct: 941, total: 951, status: 'passed' as const, issues: '10 Normalization Issues' },
  { name: 'State/Province', accuracy: 98, correct: 655, total: 668, status: 'passed' as const, issues: '13 Region Mismatch' },
  { name: 'PostalCode', accuracy: 99, correct: 866, total: 875, status: 'passed' as const, issues: '9 Format Inconsistencies' },
  { name: 'Country', accuracy: 99, correct: 963, total: 973, status: 'passed' as const, issues: '10 ISO Code Mismatches' },
  { name: 'Company_email', accuracy: 97, correct: 256, total: 264, status: 'passed' as const, issues: '8 Invalid / Bounced' },
  { name: 'Country Code', accuracy: 99, correct: 351, total: 355, status: 'passed' as const, issues: '4 Prefix Mismatch' },
  { name: 'Phone', accuracy: 98, correct: 452, total: 461, status: 'passed' as const, issues: '9 Format Inconsistencies' },
  { name: 'Fax', accuracy: 96, correct: 102, total: 106, status: 'passed' as const, issues: '4 Disconnected Lines' },
  { name: 'TollFree', accuracy: 96, correct: 53, total: 55, status: 'passed' as const, issues: '2 Routing Errors' },
  { name: 'Company_LinkedIn', accuracy: 97, correct: 278, total: 287, status: 'passed' as const, issues: '9 Broken / Redirected URLs' },
  { name: 'Website', accuracy: 98, correct: 497, total: 507, status: 'passed' as const, issues: '10 Broken / Redirected URLs' },
  { name: 'First Name', accuracy: 99, correct: 5048, total: 5099, status: 'passed' as const, issues: '51 Parse Warnings' },
  { name: 'Middle Name', accuracy: 97, correct: 972, total: 1002, status: 'passed' as const, issues: '30 Parse Warnings' },
  { name: 'Last Name', accuracy: 99, correct: 5048, total: 5099, status: 'passed' as const, issues: '51 Parse Warnings' },
  { name: 'Suffix', accuracy: 94, correct: 17, total: 18, status: 'passed' as const, issues: '1 Normalization Issue' },
  { name: 'Executive Title', accuracy: 98, correct: 4997, total: 5099, status: 'passed' as const, issues: '102 Title Parse Warnings' },
  { name: 'Number of Employees', accuracy: 98, correct: 542, total: 553, status: 'passed' as const, issues: '11 Outdated / Banded Ranges' },
